"""payments rls and permission seed

Revision ID: a8c3f6e2b7d4
Revises: 2faf0f9749b2
Create Date: 2026-08-13 11:52:00.000000

Enables RLS on the 2 new payment tables (same strict pattern as every
other tenant-scoped table -- see e650e40e66c3) and bulk-inserts the 3 new
payments.* permission codes (the rest of PERMISSION_CATALOG is already
...
revision: str = 'a8c3f6e2b7d4'
down_revision: Union[str, None] = '2faf0f9749b2'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

STRICT_TABLES = ["payments", "payment_allocations"]
...
def upgrade() -> None:
    ...
    op.execute("GRANT SELECT, INSERT, UPDATE, DELETE ON payments, payment_allocations TO app_user;")
...
def downgrade() -> None:
    ...
    op.execute("REVOKE ALL ON payments, payment_allocations FROM app_user;")
