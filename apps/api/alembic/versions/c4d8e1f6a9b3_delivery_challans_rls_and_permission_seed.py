"""delivery challans rls and permission seed

Revision ID: c4d8e1f6a9b3
Revises: 8d7cc45f58d2
Create Date: 2026-08-13 11:12:00.000000

Enables RLS on the 2 new delivery-challan tables (same strict pattern as
every other tenant-scoped table -- see e650e40e66c3) and bulk-inserts the
4 new delivery_challans.* permission codes (the rest of PERMISSION_CATALOG
is already seeded by earlier migrations -- hardcoded here, not imported,
so this migration stays correct regardless of future edits to
...
down_revision: Union[str, None] = '8d7cc45f58d2'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

STRICT_TABLES = ["delivery_challans", "delivery_challan_lines"]
...
def upgrade() -> None:
    ...
    op.execute("GRANT SELECT, INSERT, UPDATE, DELETE ON delivery_challans, delivery_challan_lines TO app_user;")
...
def downgrade() -> None:
    ...
    op.execute("REVOKE ALL ON delivery_challans, delivery_challan_lines FROM app_user;")
